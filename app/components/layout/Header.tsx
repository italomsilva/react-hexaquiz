    ...
    <header className="sticky top-0 left-0 right-0 h-16 bg-background/80 backdrop-blur-md border-b border-border-subtle z-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <ThemeToggle />
          <Link href="/profile" className="w-10 h-10 rounded-full bg-surface-elevated border border-border-standard flex items-center justify-center overflow-hidden hover:border-primary transition-colors">
